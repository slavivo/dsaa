...
class TrainState:
    ...
    this_mmlu_acc: float | None = None
    this_swuggy_acc: float | None = None
    this_sblimp_acc: float | None = None
    this_ssc_acc: float | None = None
    this_cd_acc: dict[str, float] | None = None
