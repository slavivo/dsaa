...
from .lm import LMModel, TextLMModel
...
class CheckpointInfo:
    ...
    mimi_weights: Path
    tokenizer: Path
    text_llm: torch.nn.Module | None = None
    ...
    def get_text_tokenizer(self, repo_id: str | None = None) -> sentencepiece.SentencePieceProcessor | AutoTokenizer:
        if not repo_id:
